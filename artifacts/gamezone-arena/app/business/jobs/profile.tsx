...
export default function Profile() {
  ...
  useEffect(()=>{ if(q.data){ setF({...q.data,category:q.data.category??""}); setSkills(q.data.skills.join(", ")); } },[q.data]);
