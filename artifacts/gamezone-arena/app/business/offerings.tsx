...
export default function Offerings(){
  ...
  return <View style={s.root}><View style={s.header}><Text style={s.title}>Products & Services</Text><Pressable accessibilityLabel="Open my basket" style={s.basket} onPress={()=>router.push("/business/offering/basket" as any)}><Feather name="shopping-bag" size={23} color={colors.light.primary}/>{(basket.data??0)>0?<View style={s.badge}><Text style={s.badgeText}>{basket.data!>99?"99+":basket.data}</Text></View>:null}</Pressable></View>
